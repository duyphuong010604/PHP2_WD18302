<section id="home" class="d-flex flex-column justify-content-center align-items-center">
    <div class="home-container" data-aos="fade-in">
      ...
      <p>Phục vụ khách hàng <span class="typed"
          data-typed-items="hết mình, tận tâm, trân trọng, vui vẻ"></span></p>
    </div>
  </section><!-- End home -->

  <main id="main">
    <section id="shift" class="intro">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="frist_name" id="frist_name" placeholder="Tên"
                      value="">
                  </div>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="addrees" id="addrees" placeholder="Địa chỉ"
                      value="">
                  </div>
                </div>
                <div class="col-md-6 mb-3">
