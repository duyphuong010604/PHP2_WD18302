        ...
        <a href="#" class="linkedin"><i class="bx bxl-linkedin"></i></a> -->
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="/home#calam" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Ca
                                làm</span></a>
                    </li>
                    <li><a href="/home#chamcong" class="nav-link scrollto"><i class="bi bi-check-circle"></i>
                            <span>Chấm
                                công</span></a>
                    </li>
                    ...
                    <li><a href="?url=ThongtincanhanController" class="nav-link scrollto"><i class="bx bx-server"></i>
                            <span>Quản lý
                                tài
                                khoản</span></a></li>
                    <li><a href="?url=LoginController" class="nav-link scrollto"><i class="bi bi-box-arrow-left"></i>
                            <span>Đăng
                                xuất</span></a>
                    </li>
                </ul>
